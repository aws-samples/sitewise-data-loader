...
@Module({
  imports: [
    ...
    PropertyValueStorageModule.forRoot({
      numberOfPartitions: parseInt(process.env.PROPERTY_VALUE_STORAGE_NUM_OF_PT) || 10,
      partitionSize: parseInt(process.env.PROPERTY_VALUE_STORAGE_SIZE_OF_PT) || 2 ^ 32,
      aggregationInterval: parseInt(process.env.PROPERTY_VALUE_STORAGE_INTERVAL) || 0,
    }),
    HighPriorityModule,
